...
extension ItemModel {
    static func dummy() -> [ItemModel] {
        return [
            ...
            ItemModel(itemImg: .product9, name: "락스", price: "5000", heartIsSelected: false),
            ItemModel(itemImg: .rectangle10, name: "가방", price: "5000", heartIsSelected: false)
        ]
    }
}
